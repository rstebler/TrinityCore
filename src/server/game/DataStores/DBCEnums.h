...
enum AdventureJournalTypes
{
    ADVENTURE_JOURNAL_TYPE_INFO             = 0,
    ADVENTURE_JOURNAL_TYPE_DUNGEON          = 1,
    ADVENTURE_JOURNAL_TYPE_RAID             = 2,
    ADVENTURE_JOURNAL_TYPE_QUEST            = 3,
    ADVENTURE_JOURNAL_TYPE_BATTLEGROUND     = 4,
    ADVENTURE_JOURNAL_TYPE_ARENA            = 5,
    ADVENTURE_JOURNAL_TYPE_UNK6             = 6,
    ADVENTURE_JOURNAL_TYPE_UNK7             = 7,
    ADVENTURE_JOURNAL_TYPE_UNK8             = 8
};
